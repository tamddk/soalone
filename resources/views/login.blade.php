...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('assets/icon/tcropped-Site-Icon-180x180.png') }}" />
            ...
            <div class="sodik-container-row">
                <div class="sodik-container-row__inner md-flex-col">
                    <div class="sodik-container-login align-middle md-w-full" style="padding: 16px;">
                        <section>
                            <form method="post" action="{{url('user/login/dologin')}}" class="row g-3 needs-validation" novalidate>
                                {{ csrf_field() }}
                                <div class="container">
                                    <div class="row d-flex justify-content-center align-items-center">
                                        <div class="card shadow-2-strong" style="border-radius: 1rem;">
                                            <div class="card-body p-5 text-center">
                                                ...
                                                <h3 class="mb-5">Login Anggota</h3>

                                                <div class="mb-3 row">
                                                    <label for="validationCustom01" class="col-sm-2 col-form-label">Email</label>
                                                    <div class="col-sm-10">
                                                        <div class="form-outline mb-4">
                                                            <input type="email" id="validationCustom01" class="form-control form-control-lg" name="email" required />
                                                ...
                                                <div class="mb-3 row">
                                                    <label for="validationCustom02" class="col-sm-2 col-form-label">Password</label>
                                                    <div class="col-sm-10">
                                                        <div class="form-outline mb-4">
                                                            <input type="password" id="validationCustom02" class="form-control form-control-lg" name="password" required />
                                                            <label class="form-label" for="validationCustom02">Password</label>
                                                        </div>
                                                    </div>
                                                </div>

                                                <button class="btn btn-primary btn-lg" type="submit" style=" width: 100%; ">Login</button>
                                                <div style="margin: 10px 0;">Atau</div>
                                                <a href="{{url('user/register')}}" style=" width: 100%;">Register</a>
                                            </div>
