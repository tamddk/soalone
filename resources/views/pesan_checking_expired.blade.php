                                            ...
                                            <div class="row gx-4 align-items-center">
                                                <div class="col-xl-8 col-xxl-12">
                                                    <div class="text-center text-xl-start text-xxl-center px-4 mb-4 mb-xl-0 mb-xxl-4">
                                                        <h1 class="text-primary">Opps !</h1>
                                                        <p class="text-gray-700 mb-0">Looks ticket has expired or has been used!</p>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-xxl-12 text-center">
                                                    <img src="{{url('assets/images/article-not-found.gif')}}" class="img-fluid" style="max-width: 26rem;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
