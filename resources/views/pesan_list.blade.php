                                ...
                                <div class="col-xxl-4 col-xl-12 mb-4">
                                    <div class="card mb-4 h-100">
                                        <div class="card-body h-100 d-flex flex-column justify-content-center py-5 py-xl-4">
                                            <table id="orderList" class="table table-striped" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Id Order</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><?php echo $i++ ?></td>
                                                        <td>{{ $orders->id_ticket }}</td>
                                                        <td>{{ $orders->name_order }}</td>
                                                        <td>{{ $orders->email_order }}</td>
                                                        <td>{{ $orders->hp_order }}</td>
                                                        <td>{{ $orders->type_artist_order }}</td>
                                                        <td>{{ $orders->type_ticket_order }}</td>
                                                        <td>{{ $orders->count_ticket_order }}</td>
                                                        <td class="d-flex">
                                                            <a href="{{url('user/dashboard/order/update')}}/{{ $orders->id_order }}" class="my-1 me-2 btn btn-primary btn-xs btn-icon">
                                                                <i class="oi" data-glyph="pencil"></i>
                                                            </a>
                                                            <span class="sodik-space"></span>
                                                            <a href="order/delete/{{ $orders->id_order }}" class="my-1 me-2 btn btn-primary btn-xs btn-icon">
