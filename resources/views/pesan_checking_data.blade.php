                                ...
                                <div class="col-xxl-4 col-xl-12 mb-4">
                                    <div class="card mb-4 h-100">
                                        <div class="card-body h-100 d-flex flex-column justify-content-center py-5 py-xl-4">
                                            <h2>Ticket Order Found</h2>
                                            <div class="sbp-preview">
                                                <div class="sbp-preview-content">
                                                    @foreach($order as $orders)
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1">ID ORDER</label>
                                                        <span class="form-control">{{$orders->id_ticket }}</span>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1">FullName</label>
                                                        <span class="form-control">{{$orders->name_order }}</span>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1">Email</label>
                                                        <span class="form-control">{{$orders->email_order }}</span>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1">Birth Day</label>
                                                        <span class="form-control">{{$orders->birth_order }}</span>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1">Number Phone</label>
                                                        <span class="form-control">{{$orders->hp_order }}</span>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1">Address</label>
                                                        <span class="form-control">{{$orders->address_order }}</span>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1">Artist Order</label>
                                                        <span class="form-control">{{$orders->type_artist_order }}</span>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1">Type Ticket Order</label>
                                                        <span class="form-control">{{$orders->type_ticket_order }}</span>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleFormControlInput1">Amount Ticket Order</label>
                                                        <span class="form-control">{{$orders->count_ticket_order }}</span>
                                                    </div>
                                                    @endforeach
                                                </div>
                                            </div>
